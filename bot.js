...
[❖═══════ اوامر الميوزك 🎧  ═══════❖]
:arrow_right: ** ^^2play ~ لتشغيل اغنية **
:arrow_right: ** ^^2join ~ لدخو رومك صوتي  **
:arrow_right: ** ^^2disconnect ~ خروج من الروم الصوتي **
:arrow_right: ** ^^2skip ~  لتخطي الاغنية **
:arrow_right: ** ^^2pause  ~ ايقاف الاغنية مؤقتان** 
:arrow_right: ** ^^2resume  ~  تكملة الاغنية ** 
:arrow_right: ** ^^2queue  ~  اظهار قائمة التشغيل ** 
:arrow_right: ** ^^2np  ~ اظهار الاغنية اللي انت مشغلها حاليا** 
[❖═══════ اوامر اخري═══════❖]
:arrow_right: ** ^^2inv ~ لارسال رابط دعوه البوت **
:arrow_right: ** ^^2bot ~ لعرض معلومات عن بوت **
:arrow_right: ** ^^2suppport ~ لارسال رابط سيرفر خادم بوت **
`)
...
client.user.setGame(`!~[ Čømmäñđš l ^^2help]~!`,"http://twitch.tv/Death Shop")
